...
HD_PWD='D:/大三/大三下/CPU/RISCV_FPGA_TrueDualPort_Example/RISCV_FPGA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log riscv_mcu_tdpram_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source riscv_mcu_tdpram_top.tcl
