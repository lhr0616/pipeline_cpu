...
HD_PWD='D:/FPGA/RISCV_FPGA_TrueDualPort_Example/RISCV_FPGA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log riscv_mcu_tdpram_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source riscv_mcu_tdpram_top.tcl -notrace
